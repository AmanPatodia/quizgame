...
void java(){
	...
	cout<<i+1<<")Java is short for \"JavaScript\""<<endl;
	...
	cout<<i+1<<") How do you insert COMMENTS in Java code?"<<endl;

	cout<<"a) // comment /* comment */"<<endl;
	...
	cout<<i+1<<") Which data type is used to create a variable that should store text?"<<endl;
	...
	cout<<i+1<<")  How do you create a variable with the numeric value 5?"<<endl;

	cout<<"a) int x=5"<<endl;

	cout<<"b) float x=5"<<endl;
...
void html(){
	...
	cout<<i+1<<") HTML is what type of language ?"<<endl;
	...
	cout<<i+1<<")The year in which HTML was first proposed _______."<<endl;
	...
	cout<<i+1<<") Fundamental HTML Block is known as ___________."<<endl;

	cout<<"a) HTML Body"<<endl;

	cout<<"b) HTML Tag"<<endl;

	cout<<"c) HTML Attribute"<<endl;
    cout<<"d) HTML Element"<<endl;
	...
	cout<<i+1<<")Apart from <b> tag, what other tag makes text bold ?"<<endl;
	...
	cout<<i+1<<")  What should be the first tag in any HTML document?"<<endl;
	...
	cout<<i+1<<") What tag is used to display a picture in a HTML page?"<<endl;
	...
	cout<<i+1<<")HTML tags are surrounded by which type of brackets."<<endl;
